/*
  ...
  - A unique constraint covering the columns `[userId,day]` on the table `MoodEntry` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `updatedAt` to the `Account` table without a default value. This is not possible if the table is not empty.
  - Added the required column `day` to the `MoodEntry` table without a default value. This is not possible if the table is not empty.
